...
(function (k) {
    ...
    (function (f) {
        var k = f.defaultOptions, A = f.doc, B = f.Chart, x = f.addEvent, H = f.removeEvent, E = f.fireEvent, p = f.createElement, C = f.discardElement, v = f.css, n = f.merge, q = f.pick, h = f.each, F = f.objectEach, t = f.extend, I = f.isTouchDevice, D = f.win, G = D.navigator.userAgent, J = f.Renderer.prototype.symbols;
        /Edge\/|Trident\/|MSIE /.test(G);
        /firefox/i.test(G);
        t(k.lang, {printChart: "Print chart", downloadPNG: "Download PNG image", downloadJPEG: "Download JPEG image",
        ...
        n(!0, k.navigation, {menuStyle: {border: "1px solid #999999", background: "#ffffff", padding: "5px 0"}, menuItemStyle: {padding: "0.5em 1em", background: "none", color: "#333333", fontSize: I ? "14px" : "11px", transition: "background 250ms, color 250ms"}, menuItemHoverStyle: {background: "#335cad",
        ...
        t(B.prototype, {sanitizeSVG: function (a, b) {
            ...
            l || (d[n] = l = p("div", {className: a}, {position: "absolute", zIndex: 1E3, padding: y + "px"},
                d.container), z = p("div", {className: "highcharts-menu"}, null, l), v(z, t({MozBoxShadow: "3px 3px 10px #888", WebkitBoxShadow: "3px 3px 10px #888", boxShadow: "3px 3px 10px #888"}, u.menuStyle)), q = function () {
                v(l, {display: "none"});
                g && g.setState(0);
                d.openMenu = !1
                ...
                if (f.isObject(a, !0)) {
                    var b;
                    a.separator ? b = p("hr", null, null, z) : (b = p("div", {className: "highcharts-menu-item", onclick: function (b) {
                        b && b.stopPropagation();
                        q();
